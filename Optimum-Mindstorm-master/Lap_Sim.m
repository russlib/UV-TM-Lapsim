...
count = 0;
v = 20; % Initial velocity (ft/s)
vel = v;
gear = 0; % Initialize gear to 0 (neutral or lowest gear)
shiftercount = 0; % Initialize shift counter
time_shifting = 0; % Initialize shift timer
ts = zeros(1, length(segment)); % Array to store shift times
...
for i = 1:1:length(segment) % for each track segment
    ...
    % Find gear for current velocity
